...
public class EpaperService {
    ...
    public void createNewsPaper(MultipartFile multipartFile) {
        fileManager.validateFile(multipartFile);
        fileManager.validateXMLAgainstXSD(multipartFile,  "/epaper.xsd");
    ...
    public EpaperDTO retriveNewsPaper(String newsPaperName, Pageable pageable) {
        Page<Epaper> epaper;
